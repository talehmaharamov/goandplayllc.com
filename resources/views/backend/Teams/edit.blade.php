            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-9">
                        ...
                        @endif
                        <div class="card">
                            <form action="{{ route('backend.teams.update',$teamElement->id) }}"
                                  class="custom-validation" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <input hidden name="id" value="{{ $teamElement->id }}">
                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div>
                                                            <input name="title[{{ $lang->code }}]" type="text"
                                                                   ...
                                                                   value="{{ ($lang->code == 'en') ? $teamElement->title_en : $teamElement->title_az }}"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div>
                                                            <textarea name="description[{{ $lang->code }}]" type="text"
                                                                      class="form-control"
                                                                      placeholder="@lang('backend.description')">{{ ($lang->code == 'en') ? $teamElement->description_en : $teamElement->description_az }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
