        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">@lang('backend.new') {{ (Session()->get('applocale') == 'en' ? $currentPage->name_en : $currentPage->name_az) }}
                                Element</h4>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.createElement',$currentPage->id) }}"
                                  class="custom-validation" method="post" enctype="multipart/form-data">
                                @csrf
{{--                                @method('PUT')--}}
                                <div class="card-body">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <input hidden name="id" value=" {{ $currentPage->id }} " >
