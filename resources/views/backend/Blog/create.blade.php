        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.blogs.store',app()->getLocale()) }}"
                                            ...
                                            <div class="tab-pane @if($loop->first) active show @endif" id="{{ $lang->code }}"
                                                ...
                                                <div class="form-group row">
                                                    <div class="mb-3">
                                                        ...
                                                        <div>
                                                            <input name="title[{{ $lang->code }}]" type="text" class="form-control"
                ...
                {{--                        <div class="card">--}}
                {{--                            <div class="card-body">--}}
                {{--                                <form action="{{ route('backend.blogs.store',app()->getLocale()) }}" class="custom-validation" method="post" enctype="multipart/form-data">--}}
                {{--                                    @csrf--}}
                {{--                                    <div class="mb-3">--}}
                {{--                                        <label>@lang('backend.title'):</label>--}}
                {{--                                        <div>--}}
                {{--                                            <input name="title" type="text" class="form-control" required="" data-parsley-minlength="6" placeholder="@lang('backend.title')">--}}
                {{--                                        </div>--}}
                {{--                                    </div>--}}
                {{--                                    <div class="mb-3">--}}
                {{--                                        <label>@lang('backend.link'):</label>--}}
                {{--                                        <div>--}}
                {{--                                            <input name="link" type="text" class="form-control" data-parsley-maxlength="6" placeholder="@lang('backend.link')">--}}
                {{--                                        </div>--}}
                {{--                                    </div>--}}
                ...
                {{--                                        <label>@lang('backend.description'):</label>--}}
                {{--                                        <div>--}}
                {{--                                            <textarea name="description" type="text" class="form-control" placeholder="@lang('backend.description')"></textarea>--}}
                {{--                                        </div>--}}
                {{--                                    </div>--}}
                ...
                {{--                                        <label>@lang('backend.photo'):</label>--}}
                {{--                                        <div>--}}
                {{--                                            <input name="photo" type="file" class="form-control" required="" data-parsley-pattern="#[A-Fa-f0-9]{6}">--}}
                {{--                                        </div>--}}
                {{--                                    </div>--}}
