                        ...
                        <table id="datatable-buttons"
                            ...
                            @foreach($settings as $setting)
                                <tr>
                                    ...
                                    <td>{{ $setting->guard }}</td>
                                    <td>
                                        <a href="{{ route('backend.settingStatus',['id'=>$setting->id]) }}"
                                           class="btn btn-{{ $setting->status == 1 ? 'success' : 'secondary' }}">{{ $setting->status == 1 ? __('backend.active') : __('backend.deactive') }}</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-info"
                                           href={{ route('backend.settings.edit',['setting'=>$setting->id]) }}>
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a class="btn btn-danger"
                                           href="{{ route('backend.delSetting',['id'=>$setting->id]) }}">
